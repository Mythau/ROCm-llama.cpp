...
static void test_identity_iteration_id() {
    inference::identity::iteration_id id{ 1 };
    assert(id.value == 1);
    id.value++;
    assert(id.value == 2);
    inference::identity::iteration_id id2{ 2 };
    assert(id == id2);
    inference::identity::iteration_id id3{ 3 };
    assert(!(id == id3));
    assert(id3.value == 3);
}
